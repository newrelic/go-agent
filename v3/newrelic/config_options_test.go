...
func TestConfigRemoteParentSampledOn(t *testing.T) {
	cfgOpt := ConfigRemoteParentSampled(true)
	cfg := defaultConfig()
	cfgOpt(&cfg)
...
func TestConfigRemoteParentSampledOff(t *testing.T) {
	cfgOpt := ConfigRemoteParentSampled(false)
	cfg := defaultConfig()
	cfgOpt(&cfg)
...
func TestConfigRemoteParentNotSampledOn(t *testing.T) {
	cfgOpt := ConfigRemoteParentNotSampled(true)
	cfg := defaultConfig()
	cfgOpt(&cfg)
...
func TestConfigRemoteParentNotSampledOff(t *testing.T) {
	cfgOpt := ConfigRemoteParentNotSampled(false)
	cfg := defaultConfig()
	cfgOpt(&cfg)
