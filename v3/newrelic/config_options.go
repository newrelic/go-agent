...
// Flags are "always_on", "always_off", and "default".
// if always_on is set, the priority is set to 2 ("always_on").
// if always_off is set, the priority is set to 0 ("always_off").
// if default is set, the priority is set to a priority that is generated by New Relic.

func ConfigRemoteParentSampled(flag string) ConfigOption {
	return func(cfg *Config) {
		if flag == "always_on" {
			cfg.DistributedTracer.Sampler.RemoteParentSampled = "always_on"
		} else if flag == "always_off" {
...
// if always_off is set, the priority is set to 0 ("always_off").
// if default is set, the priority is set to a priority that is generated by New Relic.
func ConfigRemoteParentNotSampled(flag string) ConfigOption {
	return func(cfg *Config) {
		if flag == "always_on" {
