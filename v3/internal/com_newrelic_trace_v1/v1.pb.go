...
var file_v3_internal_com_newrelic_trace_v1_v1_proto_goTypes = []any{
...
func file_v3_internal_com_newrelic_trace_v1_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v3_internal_com_newrelic_trace_v1_v1_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_v3_internal_com_newrelic_trace_v1_v1_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Span); i {
			case 0:
				return &v.state
			case 1:
		...
		file_v3_internal_com_newrelic_trace_v1_v1_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_v3_internal_com_newrelic_trace_v1_v1_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_v3_internal_com_newrelic_trace_v1_v1_proto_msgTypes[2].OneofWrappers = []any{
