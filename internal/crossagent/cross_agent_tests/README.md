...
| [distributed_tracing](distributed_tracing) | These tests affirm distributed trace payload generation and handling, intrinsics generation, and event generation.  See [Distributed Tracing spec](https://source.datanerd.us/agents/agent-specs/blob/master/Distributed-Tracing.md) |