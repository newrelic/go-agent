...
* Added support for [NATS](https://github.com/nats-io/nats.go) and [STAN](https://github.com/nats-io/stan.go) monitoring 
with the new [_integrations/nrnats](https://godoc.org/github.com/newrelic/go-agent/_integrations/nrnats) and 
...
support instrumentation of publishers and subscribers.
  ...
  * [STAN Example](https://github.com/newrelic/go-agent/go-agent/blob/master/_integrations/nrstan/examples/main.go)
